Filename FILE2024     ('\\systema44\Migracion\e100\M10124.asu'
                       '\\systema44\Migracion\e100\M10224.asu'
                       '\\systema44\Migracion\e100\M10324.asu' 
					   '\\systema44\Migracion\e100\M10424.asu'
                       '\\systema44\Migracion\e100\M10524.asu'
					   '\\systema44\Migracion\e100\M10624.asu' 
					   '\\systema44\Migracion\e100\M10724.asu'
					   '\\systema44\Migracion\e100\M10824.asu'
					   '\\systema44\Migracion\e100\M10924.asu'
					   '\\systema44\Migracion\e100\M11024.asu'
					   '\\systema44\Migracion\e100\M11124.asu'
					   '\\systema44\Migracion\e100\M11224.asu') LRECL=450;
...
%MACRO CIF(VAR);
DATA FILE2024; INFILE FILE2024;LRECL=450;

input 		 @1 FECH $4. @3 MES 2. @5 ADUA 2. @7 PAOR 3. 
             @10 PAPR 3. @13 PACO 3. @16 DEPTO 2. @169 ciudad 29. 
...
proc sort data=FILE2024;by &var;
proc sort data=FILE2025;by &var;
proc sort data=FILE2026;by &var;

proc summary data=FILE2024;
var CIFDO CIFPE KNETO PBK CANU;
by &var;
output out=TOTAL2024 
sum(CIFDO CIFPE FOBDO KNETO PBK CANU)=CIFDO2024 CIFPE2024 FOBDO2024 KNETO2024 PBK2024 CANU2024;
...
data IMPO.TOTAL&VAR;
merge TOTAL2026 TOTAL2025 TOTAL2024;
by &var;
drop _type_;
RUN;
%MEND CIF;

%CIF(posara mes paor regimen NIT RAZON);RUN; 
...
data EjeNIT;
    merge impo.totalposara (in=A) IMPO.corre62;
    by posara;
...
proc export
    data=EjeNIT
    outfile='\\DIMPE-D-081\d\COMEX\IMPO\Resultados\Importaciones 2026_NIT.XLSX'
    dbms=excel
    replace;
run;
